...
tf.app.flags.DEFINE_float('learning_rate', 1e-3,
                          'Learning rate.')
tf.app.flags.DEFINE_list('reduce_lr_after', [], 'Reduce the learning rate after this many iterations.')
...
def main(argv=None):
    ...
    global image_pl, label_pl, label_fr, pred_fr, loss, time_window
    data_list = {}

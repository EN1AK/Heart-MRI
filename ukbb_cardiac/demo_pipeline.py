...
'''
    ...
    os.system('python short_axis/eval_ventricular_volume.py --data_dir demo_image --output_csv demo_csv/table_ventricular_volume.csv')
    ...
    # Deploy the segmentation network
    print('Deploying the segmentation network ...')
    os.system('python common/deploy_network.py --seq_name la_2ch --data_dir demo_image '
              '--model_path trained_model/FCN_la_2ch')

    os.system('python common/deploy_network.py --seq_name la_4ch --data_dir demo_image '
    ...
    # Deploy the segmentation network
    print('Deploying the segmentation network ...')
    os.system('python common/deploy_network_ao.py --seq_name ao --data_dir demo_image '
